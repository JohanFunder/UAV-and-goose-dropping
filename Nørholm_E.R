# Indlæs udtyndet csv
directory <- "G:/Projekter/Noerholm_V_UTM10m"

Nørholm_V_10m <- file.path(directory,"Noerholm_V_UTM10meter.csv")
Nørholm_V_10m
...
current.folder <- "G:/Overflyvninger_lave/april_12_Nørholm_vest_lav_overflyvning"

New <- dir.create("G:/Projekter/Noerholm_V_UTM10m/Thin")
new.folder <- ("New")
...
file.copy(file.path("G:/Overflyvninger_lave/april_12_Nørholm_vest_lav_overflyvning",
                    list.of.files), "G:/Projekter/Noerholm_V_UTM10m/Thin", copy.mode = TRUE)
...
system2("exiftool", args="-RelativeAltitude -GPSlatitude -GPSlongitude -GimbalYawDegree -ImageHeight -ImageWidth 
        ...
        G:/Projekter/Noerholm_V_UTM10m/Thin",
        stdout="G:/Projekter/Noerholm_V_UTM10m/N_V_photodata.csv",stderr = TRUE)

# Indlæs .csv
data1 <- read.csv("G:/Projekter/Noerholm_V_UTM10m/N_V_photodata.csv")
View(data1)

...
current.folder <- "H:/P8_projekt/Overflyvninger_lave/april_18_Klim_holme_skråmark"
...
file.copy(file.path("H:/P8_projekt/Overflyvninger_lave/april_18_Klim_holme_skråmark",
